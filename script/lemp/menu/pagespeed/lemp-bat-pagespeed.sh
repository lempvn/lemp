#!/bin/bash 
echo "========================================================================="
echo "Su dung chuc nang nay de BAT Nginx Pagespeed cho website"
echo "-------------------------------------------------------------------------"
nhapdulieu () {
...
clear
echo "========================================================================="
echo "$domain da enable pagespeed tu truoc!"
...
echo "-------------------------------------------------------------------------"
read -r -p "Ban muon BAT Nginx Pagespeed cho $domain  ? [y/N] " response
case $response in
    [yY][eE][sS]|[yY]) 
    echo "-------------------------------------------------------------------------"
...
clear
echo "========================================================================= "
echo "BAT Nginx Pagespeed cho $domain thanh cong!"
/etc/lemp/menu/pagespeed/lemp-pagespeed-menu.sh
        ;;
    *)
        clear
echo "========================================================================= "
echo "Huy bo BAT Nginx Pagespeed cho $domain "
/etc/lemp/menu/pagespeed/lemp-pagespeed-menu.sh
        ;;
esac
}

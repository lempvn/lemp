...
echo "========================================================================="
echo "Them Domain + Tu dong cai dat Wordpress + Config Vhost cho WP Rocket Cache"
echo "-------------------------------------------------------------------------"
...
echo "-------------------------------------------------------------------------"
echo "WP Rocket Cache, WP Limit Attemps, No Category Base"
echo "========================================================================="
...
#echo $website | sed "s/\./_/" | sed "s/\-/_/" | cut -c1-10  > /tmp/databasename.txt  
...
#install plugin rocket cache for free

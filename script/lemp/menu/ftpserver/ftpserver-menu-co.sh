...
options=("Tao Tai Khoan FTP Cho Website" "Xoa Hoa Tai Khoan FTP" "Thay Mat Khau Tai Khoan FTP" "Xem Thong Tin FTP Cua Website" "Go bo FTP Server" )
printf "=========================================================================\n"
...
select opt in "${options[@]}" "Thoat"; do 
    ...
    5) /etc/lemp/menu/ftpserver/ftp-server-remove.sh;;
    0) clear && lemp;;
